...
describe('getUniqPresetImportName', () => {
  it('should return valid import name', () => {
    // given
    const path:string = './src/components/Button/presets/0-default.jsx';
    const expectedImportName:string = 'Preset445bc29ee1845bac85fade5cad39109d';
  ...
  it('should return the same import name for the same input', () => {
    // given
    const path1:string = './src/components/Button/presets/1-basic.jsx';
    const path2:string = './src/components/Button/presets/1-basic.jsx';
  ...
  it('should return different import name for different input', () => {
    // given
    const path1:string = './src/components/Button/presets/1-basic.jsx';
    const path2:string = './src/components/Card/presets/1-basic.jsx';
